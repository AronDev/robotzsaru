    ...
    <body>
        ...
        if(getUserRankPerm($_SESSION['badge_number']) >= 0) {
            ...
            <div id='files-content'>
                ...
                <input class='search input-primary' type='text' id='f_search' onkeyup='search_fileName()' placeholder='Keresés sorszám alapján' style='width: 20%'><br /><br />
                <table id='files'>
                    <tr>
                    ...
                    $result = mysqli_query($mysql_id, "SELECT files.*, users.playername FROM files INNER JOIN users ON users.badge_number=files.author WHERE files.archive='1' ORDER BY timestamp DESC");
