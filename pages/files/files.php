                ...
                if(mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='files-row' id='fv-tr" . $row['dbid'] . "'>";
                            ...
                            echo "<td class='files-column'><a href='index.php?p=files&t=view&id=" . $row['dbid'] . "'><i class='far fa-eye icon'></i></a><a class='rem-file'><i class='fas fa-trash-alt icon'></i></a></td>";
                        echo "</tr>";
                    }
