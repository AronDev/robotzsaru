<?php
if($result = mysqli_query($mysql_id, "SELECT files.*, u1.playername as p1, u2.playername as p2 FROM files as f INNER JOIN users as u1 ON u1.badge_number=f.author INNER JOIN users as u2 ON u2.badge_number=f.edited_by WHERE f.dbid='$id'")) {
